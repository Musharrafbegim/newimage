...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__fonts_main_css__ = __webpack_require__(4);
...
var _objectFitImages = __webpack_require__(8);var _objectFitImages2 = _interopRequireDefault(_objectFitImages);
var _wowjs = __webpack_require__(9);
__webpack_require__(10);
__webpack_require__(2);
var _scrollmagic = __webpack_require__(1);var ScrollMagic = _interopRequireWildcard(_scrollmagic);function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

(0, _jquery2.default)(document).ready(function () {
  (0, _objectFitImages2.default)();

  var $status = (0, _jquery2.default)('.cover-slider__paging');
  var $slickElement = (0, _jquery2.default)('.cover-slider');
  ...
  $clientsSlider.on('init reInit afterChange', function (event, slick, currentSlide, nextSlide) {
    var i = (currentSlide ? currentSlide : 0) + 1;
    (0, _jquery2.default)('.clients__pagination--current').text(i);
    (0, _jquery2.default)('.clients__pagination--total').text(slick.slideCount);
  });

  (0, _jquery2.default)(".header__nav a").click(function (e) {
    e.preventDefault();
    var aid = (0, _jquery2.default)(this).attr("href");
    (0, _jquery2.default)('html,body').animate({ scrollTop: (0, _jquery2.default)(aid).offset().top }, 'slow');
  });
  ...
  $clientsSlider.slick({
	...
	//About Client Slider
var $clientsSliderAbout = (0, _jquery2.default)('.clients__innerBig');

  $clientsSliderAbout.slick({
    autoplay: false,
	arrows: false,
	variableWidth: true,
	draggable: false,
...
function setDotsLineSize() {
  var dots = (0, _jquery2.default)('.dot');
  var coverSize = (0, _jquery2.default)(window).width() - (0, _jquery2.default)('.menu-item__cover').offset().left + 25;
  (0, _jquery2.default)('.cover__content').css('width', coverSize);
  (0, _jquery2.default)('.cover-slider__wrap').css('width', (0, _jquery2.default)(window).width() - coverSize);
  dots.each(function (index) {
    var parent = (0, _jquery2.default)(this).parent();
    var line = parent.find('.line');
    var leftOffset = parent.offset().left + parent.width() / 2;
    (0, _jquery2.default)(this).css('left', leftOffset);
    line.css('height', (0, _jquery2.default)('.page').height() - 200);
    line.css('left', leftOffset + 5);
  });
  (0, _jquery2.default)('.menu-item__cover .line').css('height', (0, _jquery2.default)('#cover .rectangle').offset().top - 100);
}

function setActiveMenuItemOnScroll() {
  var topMenu = (0, _jquery2.default)(".nav"),
  ...
  var coverReactTop = (0, _jquery2.default)('#cover .rectangle').offset().top;
  var credentials = (0, _jquery2.default)('#credentials').offset().top + (0, _jquery2.default)('#credentials').height() + 200;
  var team = (0, _jquery2.default)('#team').offset().top + (0, _jquery2.default)('#team').height() + 200;
  var partner = (0, _jquery2.default)('#partner').offset().top + (0, _jquery2.default)('#partner').height() + 200;
  var contact = (0, _jquery2.default)('#contact').offset().top + (0, _jquery2.default)('#contact').height() + 200;

  (0, _jquery2.default)(window).scroll(function () {
    var fromTop = (0, _jquery2.default)(this).scrollTop() + topMenuHeight;
    if (fromTop > coverReactTop - 80) {
      (0, _jquery2.default)('.menu-item__cover .line').hide();
      (0, _jquery2.default)('.menu-item__cover .dot').hide();
    } else {
      (0, _jquery2.default)('.menu-item__cover .line').show();
      (0, _jquery2.default)('.menu-item__cover .dot').show();
    }

    if (fromTop > credentials) {
      (0, _jquery2.default)('.menu-item__credentials .line').hide();
      (0, _jquery2.default)('.menu-item__credentials .dot').hide();
    } else {
      (0, _jquery2.default)('.menu-item__credentials .line').show();
      (0, _jquery2.default)('.menu-item__credentials .dot').show();
    }

    if (fromTop > team) {
      (0, _jquery2.default)('.menu-item__team .line').hide();
      (0, _jquery2.default)('.menu-item__team .dot').hide();
    } else {
      (0, _jquery2.default)('.menu-item__team .line').show();
      (0, _jquery2.default)('.menu-item__team .dot').show();
    }

    if (fromTop > partner) {
      (0, _jquery2.default)('.menu-item__partner .line').hide();
      (0, _jquery2.default)('.menu-item__partner .dot').hide();
    } else {
      (0, _jquery2.default)('.menu-item__partner .line').show();
      (0, _jquery2.default)('.menu-item__partner .dot').show();
    }

    if (fromTop > contact) {
      (0, _jquery2.default)('.menu-item__contact .line').hide();
      (0, _jquery2.default)('.menu-item__contact .dot').hide();
    } else {
      (0, _jquery2.default)('.menu-item__contact .line').show();
      (0, _jquery2.default)('.menu-item__contact .dot').show();
    }
...
function parallaxAnimation() {
	...
	// create a scene
	var scene = new ScrollMagic.Scene({ triggerElement: "#trigger-1", duration: (0, _jquery2.default)('#element-2').offset().top - (0, _jquery2.default)('#element-1').offset().top }).
	setPin("#element-1").
	addTo(controller);
  
	var scene = new ScrollMagic.Scene({ triggerElement: "#trigger-2" }).
	setVelocity("#element-1", { opacity: 0 }, { duration: 0 }).
	addTo(controller);
  
	var scene = new ScrollMagic.Scene({ triggerElement: "#trigger-2", duration: (0, _jquery2.default)('#element-3').offset().top - (0, _jquery2.default)('#element-2').offset().top }).
	setPin("#element-2").
	addTo(controller);
	...
	if(window.innerWidth >= 1600){
		...
		var scene = new ScrollMagic.Scene({ triggerElement: "#trigger-3", duration: (0, _jquery2.default)('.contact-form').offset().top - (0, _jquery2.default)('#element-3').offset().top + 18 }).
	setPin("#element-3").
	addTo(controller);
	...
	addTo(controller);
	var scene = new ScrollMagic.Scene({ triggerElement: "#trigger-6" }).
	setVelocity( "#element-4", { opacity: 0 }, { duration: 0 }).
	addTo(controller);
	var scene = new ScrollMagic.Scene({ triggerElement: "#trigger-6" }).
	setVelocity( "#element-3", { opacity: 0 }, { duration: 0 }).
	addTo(controller);
	var scene = new ScrollMagic.Scene({ triggerElement: "#trigger-6" }).
	setVelocity( "#element-2", { opacity: 0 }, { duration: 0 }).
	addTo(controller);
